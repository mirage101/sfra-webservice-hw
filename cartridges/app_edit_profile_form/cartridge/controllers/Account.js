...
server.get(
    ...
    function (req, res, next) {
        ...
        profileForm.customer.contryresidence.value = customer.profile.custom.contryresidence;
...
server.post(
    ...
    function (req, res, next) {
        ...
        var result = {
            ...
            interests: profileForm.customer.interests.htmlValue,
            contryresidence: profileForm.customer.contryresidence.value,
            profileForm: profileForm
        };
            ...
            this.on('route:BeforeComplete', function (req, res) { // eslint-disable-line no-shadow
                ...
                if (customerLogin) {
                    Transaction.wrap(function () {
                        ...
                        profile.custom.contryresidence = formInfo.contryresidence;
                    });
